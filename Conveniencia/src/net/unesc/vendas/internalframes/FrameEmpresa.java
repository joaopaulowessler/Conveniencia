...
import net.unesc.vendas.actions.ActionEmpresa;
...
public class FrameEmpresa extends javax.swing.JInternalFrame {
    ...
    private ActionEmpresa actEmpresa = new ActionEmpresa(this);
    
    public FrameEmpresa() {
        initComponents();
        
        salvar.addActionListener(actEmpresa);
        excluir.addActionListener(actEmpresa);
        cancelar.addActionListener(actEmpresa);
        novo.addActionListener(actEmpresa);
    }    
    
    public void novoEmpresa(){        
        nome.setText("");                
    ...
    private void codigoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_codigoFocusLost
        ...
        if(codTxt.length() > 0){
            ...
            Empresa con = EmpresaDao.getEmpresa(codigo);
    ...
    private void setEmpresa(Empresa con) {
        codigo.setText(String.valueOf(con.getEmpCodigo()));
        nome.setText(con.getEmpNome());        
    }
    
    public Empresa getEmpresa()throws ExceptionVendas{
        ...
        if (nome.getText().trim().isEmpty()){
            nome.requestFocus();
            throw new ExceptionVendas("Nome da Empresa deve ser informado!");
        }
        
        con.setEmpCodigo(Integer.parseInt(codigo.getText()));
        con.setEmpNome(nome.getText());        
