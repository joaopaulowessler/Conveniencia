...
import net.unesc.vendas.actions.ActionEstado;
...
public class FrameEstado extends javax.swing.JInternalFrame {

    private ActionEstado actEstado = new ActionEstado(this);
    
    public FrameEstado() {
        initComponents();
        
        salvar.addActionListener(actEstado);
        excluir.addActionListener(actEstado);
        cancelar.addActionListener(actEstado);
        novo.addActionListener(actEstado);
    }    
    ...
    private void initComponents() {
        ...
        sigla.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                siglaKeyReleased(evt);
            }
        });

        jLabel34.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel34.setText("Sigla:");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(sigla, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(388, 388, 388))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void codigoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_codigoFocusLost
        ...
        if(codTxt.length() > 0){
            ...
            Estado est = EstadoDao.getEstado(codigo);
    ...
    private void siglaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_siglaKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_siglaKeyReleased
    ...
    private void setEstado(Estado est) {
        codigo.setText(String.valueOf(est.getEstCodigo()));
        nome.setText(est.getEstNome());        
        sigla.setText(est.getEstSigla());        
    }
    
    public Estado getEstado()throws ExceptionVendas{
        ...
        if (nome.getText().trim().isEmpty()){
            nome.requestFocus();
            throw new ExceptionVendas("Nome do Estado deve ser informado!");
        }
        ...
        est.setEstCodigo(Integer.parseInt(codigo.getText()));
        est.setEstNome(nome.getText());        
        est.setEstSigla(sigla.getText());        
