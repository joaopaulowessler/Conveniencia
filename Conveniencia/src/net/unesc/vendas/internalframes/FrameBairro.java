...
import net.unesc.vendas.actions.ActionBairro;
...
public class FrameBairro extends javax.swing.JInternalFrame {

    private ActionBairro actBairro = new ActionBairro(this);
    
    public FrameBairro() {
        initComponents();
        
        salvar.addActionListener(actBairro);
        excluir.addActionListener(actBairro);
        cancelar.addActionListener(actBairro);
        novo.addActionListener(actBairro);
    }    
    ...
    private void codigoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_codigoFocusLost
        ...
        if(codTxt.length() > 0){
            ...
            Bairro bai = BairroDao.getBairro(codigo);
    ...
    private void setBairro(Bairro bai) {
        codigo.setText(String.valueOf(bai.getBaiCodigo()));
        nome.setText(bai.getBaiNome());
    }
    
    public Bairro getBairro()throws ExceptionVendas{
        ...
        if (nome.getText().trim().isEmpty()){
            nome.requestFocus();
            throw new ExceptionVendas("Nome do Bairro deve ser informado!");
        }
        
        bai.setBaiCodigo(Integer.parseInt(codigo.getText()));
        bai.setBaiNome(nome.getText());                
