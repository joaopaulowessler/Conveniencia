...
import net.unesc.vendas.actions.ActionCidade;
...
public class FrameCidade extends javax.swing.JInternalFrame {

    private ActionCidade actCidade = new ActionCidade(this);
    
    public FrameCidade() {
        initComponents();
        
        salvar.addActionListener(actCidade);
        excluir.addActionListener(actCidade);
        cancelar.addActionListener(actCidade);
        novo.addActionListener(actCidade);
    }    
    ...
    private void initComponents() {
        ...
        ibge.setEnabled(false);
        ibge.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                ibgeKeyReleased(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ibge, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(299, 299, 299))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void codigoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_codigoFocusLost
        ...
        if(codTxt.length() > 0){
            ...
            Cidade cid = CidadeDao.getCidade(codigo);
    ...
    private void ibgeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ibgeKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_ibgeKeyReleased
    ...
    private void setCidade(Cidade cid) {
        codigo.setText(String.valueOf(cid.getCidCodigo()));
        nome.setText(cid.getCidNome());        
        ibge.setText(String.valueOf(cid.getCidCodibge()));
    }
    
    public Cidade getCidade()throws ExceptionVendas{
        Cidade cid = new Cidade();
        
        if (codigo.getText().trim().isEmpty()){
            throw new ExceptionVendas("Código do Cidade deve ser informado!");       
        }
        
        if (!validaCaracteres(codigo.getText())) {
            throw new ExceptionVendas("Código do Cidade inválido!");
        }
        
        if (nome.getText().trim().isEmpty()){
            nome.requestFocus();
            throw new ExceptionVendas("Nome do Cidade deve ser informado!");
        }
        
        if (!ibge.getText().isEmpty() &&                
            !validaCaracteres(ibge.getText())) {
            throw new ExceptionVendas("Código IBGE da cidade inválido!");
        }
        
        cid.setCidCodigo(Integer.parseInt(codigo.getText()));
        cid.setCidNome(nome.getText());        
        cid.setCidCodibge(Integer.parseInt(ibge.getText()));        
